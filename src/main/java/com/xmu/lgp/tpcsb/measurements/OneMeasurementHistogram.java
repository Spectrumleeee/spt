...
public class OneMeasurementHistogram extends OneMeasurement {
    ...
    /**
     * The sum of each latency measurement over all operations. Calculated in
     * ms.
     */
    long totallatency;

    /**
     * The sum of each latency measurement squared over all operations. Used to
     * calculate variance of latency. Calculated in ms.
     */
