...
public abstract class Workload {
    ...
    /**
     * Do one request-response operation. Because it will be called concurrently
     * from multiple client threads, this function must be thread safe. However,
     ...
     *         when you are done.
     */
    public abstract boolean doInvoke(TPCS tpcs, Object threadstate);
